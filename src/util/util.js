...
class ErrorToast extends Toast {
  constructor(message, err, duration, action = "") {
    message += ": " + err;
    super(message, "default", duration, require("../assets/icon/toast/error-icon.svg"), action);
  }
}
class WarningToast extends Toast {
  constructor(message, duration, action = "") {
    super(message, "default", duration, require("../assets/icon/toast/warning-icon.svg"), action);
  }
}
class SuccessToast extends Toast {
  constructor(message, duration, action = "") {
    super(message, "default", duration, require("../assets/icon/toast/success-icon.svg"), action);
  }
}
/** POPUP **/
