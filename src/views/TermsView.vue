<template>
  <main class="terms">
    ...
    <p>
      ...
      FocusTime if you do not agree to take all of the terms and conditions stated on this page.
    </p>
    ...
    <p>
      ...
      <a href="https://www.app-privacy-policy.com/app-terms-conditions-generator/"
        >App Terms and Conditions Generator from App-Privacy-Policy.com</a
      >
    </p>
    <h3><strong>License</strong></h3>

    <p>
      Unless otherwise stated, FocusTime and/or its licensors own the intellectual property rights
      for all material on FocusTime. All intellectual property rights are reserved. You may access
      this from FocusTime for your own personal use subjected to restrictions set in these terms and
      conditions.
    </p>
    ...
    <p>
      Parts of this app offer an opportunity for users to post and exchange opinions and information
      in certain areas of the website. FocusTime does not filter, edit, publish or review Comments
      prior to their presence on the website. Comments do not reflect the views and opinions of
      FocusTime, its agents and/or affiliates. Comments reflect the views and opinions of the person
      who post their views and opinions. To the extent permitted by applicable laws, FocusTime shall
    ...
    <p>
      FocusTime reserves the right to monitor all Comments and to remove any Comments which can be
    ...
    <p>
      You hereby grant FocusTime a non-exclusive license to use, reproduce, edit and authorize
    ...
    <ul>
      ...
      <li>
        Online directory distributors may link to our App in the same manner as they hyperlink to
    ...
    <p>
      These organizations may link to our home page, to publications or to other App information so
    ...
    <p>
      ...
      visibility of the hyperlink compensates the absence of FocusTime; and (d) the link is in the
      context of general resource information.
    </p>

    <p>
      These organizations may link to our App so long as the link: (a) is not in any way deceptive;
    ...
    <p>
      ...
      to our App, you must inform us by sending an e-mail to FocusTime. Please include your name,
      your organization name, contact information as well as the URL of your site, a list of any
      URLs from which you intend to link to our App, and a list of the URLs on our site to which you
    ...
    <p>
      No use of FocusTime's logo or other artwork will be allowed for linking absent a trademark
      license agreement.
    </p>
    ...
    <p>
      ...
      that alter in any way the visual presentation or appearance of our App.
    </p>

    <h3><strong>Content Liability</strong></h3>

    <p>
      We shall not be hold responsible for any content that appears on your App. You agree to
      protect and defend us against all claims that is rising on our App. No link(s) should appear
    ...
    <p>
      ...
      You approve to immediately remove all links to our App upon request. We also reserve the right
    ...
    <p>
      If you find any link on our App that is offensive for any reason, you are free to contact and
    ...
    <p>
      ...
      and conditions relating to our App and the use of this website. Nothing in this disclaimer
      will:
    </p>
